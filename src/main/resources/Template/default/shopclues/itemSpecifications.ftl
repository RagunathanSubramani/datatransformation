...
<#list data?values as key>
	...
	<#if key.FeatureType == "S">"inputType" : "DropDownBox",<#elseif key.FeatureType == "M">"inputType" : "CheckBox",<#elseif key.FeatureType == "N">"inputType" : "SelectBox",<#elseif key.FeatureType == "E">"inputType" : "ExtendedSelectBox",<#elseif key.FeatureType == "T">"inputType" : "RepresentText(Others)",<#elseif key.FeatureType == "O">"inputType" : "RepresentNumber(Others)",<#elseif key.FeatureType == "D">"inputType" : "RepresentDate(Others)",<#elseif key.FeatureType == "Z">"inputType" : "RepresentTextArea(Others)",<#elseif key.FeatureType == "C">"inputType" : "RepresentSingle(Check Box )",</#if>
