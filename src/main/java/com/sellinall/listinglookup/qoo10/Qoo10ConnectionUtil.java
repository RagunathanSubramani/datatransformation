...
public class Qoo10ConnectionUtil {
	...
	public static String getQoo10ApiResponse(String params, String qoo10ApiHost, String action, String apiKey,
		...
		try {
			...
			params = params + "key="
					+ "S5bnbfynQvNi9I_g_1_oNLnmU9qgVI2GKgxrr0Zq6vX_g_2_PGphDsYvj30zDqt_g_1_6GV9awp1TYJc6dDKOCikNtR2ytVenzuD1blsaaUL_g_2_D2Jwhc4ucVsMNrVtmCNHc7_g_2_LglYxxi_g_2_";
