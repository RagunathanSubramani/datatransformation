...
public class RocketEcomConnectionUtil {
  ...
  * @param JSON String - Request Body
  * 
  *       final String out = getSellercenterApiResponse(params, ScApiHost, apiKey, JSON, "GET"); // provide XML as an empty string when not needed
